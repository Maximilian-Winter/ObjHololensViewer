        ...
        for (int meshIndex = 0; meshIndex < meshCount; meshIndex++)
        {
            ...
            for (int i = 0; i < meshFaceDataCount; i++)
            {
                ...
                else
                {
                    ...
                    {
                        normalsDic.Add(faceData[i + meshFaceDataIndexOffset].verticeIndexX - 1, faceData[i + meshFaceDataIndexOffset].verticeIndexY - 1);
                    }
                    if (faceData[i + meshFaceDataIndexOffset].verticeIndexZ >= 1)
                    {
                        uvsDic.Add(faceData[i + meshFaceDataIndexOffset].verticeIndexX - 1, faceData[i + meshFaceDataIndexOffset].verticeIndexZ - 1);
                    }
